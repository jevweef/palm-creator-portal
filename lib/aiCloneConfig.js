...
export const POSES = {
  front: {
    ...
    airtableCandidatesField: 'AI Ref Front Candidates',
  },
  back: {
    key: 'back',
    label: 'Back View',
    ...
    airtableCandidatesField: 'AI Ref Back Candidates',
  },
  face: {
    key: 'face',
    label: 'Close Up Face',
    ...
    airtableCandidatesField: 'AI Ref Face Candidates',
  },
}

export function candidateFilename(pose, index, ext = 'jpg') {
  return `${POSES[pose].fileLabel} Candidate ${index}.${ext.replace(/^\./, '')}`
}
