...
// Build a spotdown URL that pre-fills the Spotify track URL
export function getSpotdownUrl(spotifyUrl) {
  if (!spotifyUrl) return null
  // spotdown.org accepts the Spotify URL directly in the path
  return `https://spotdown.org/track/${extractSpotifyTrackId(spotifyUrl)}`
}
