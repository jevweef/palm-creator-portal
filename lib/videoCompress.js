...
// MOV → MP4 with rotation baked into the pixels.
//
// Was '-c copy' (just a container swap). Faster but preserved the source's
// rotation METADATA without rotating the pixels. Telegram + Android IG
// often ignore the tag — portrait phone videos rendered sideways. Re-encoding
// through libx264 makes ffmpeg auto-apply rotation during decode and strip
// the tag. Quality cost is negligible at CRF 18 (visually lossless), time
// cost is ~5-10s for a typical reel.
