...
<div class="page">
  ...
  <div class="section">
    ...
    <div class="section-body">
      ...
      ${commissionTier ? `<div class="highlight" style="font-size:13px;margin-top:-6px;">(INCREASES TO ${Math.round(commissionTier.tierPct)}% AFTER $${Number(commissionTier.threshold).toLocaleString()}/MONTH)</div>` : ''}
