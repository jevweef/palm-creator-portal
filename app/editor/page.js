  ...
  return (
    <div style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: '16px', overflow: 'hidden', marginBottom: '16px' }}>
      ...
      <div style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        ...
        {/* Library clips — collapsed by default */}
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: '32px', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            {totalRevisions > 0 && (
              <span style={{ padding: '5px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: 700, background: '#2d1515', color: '#ef4444', border: '1px solid #5c2020' }}>
                {totalRevisions} revision{totalRevisions > 1 ? 's' : ''} needed
              </span>
            )}
            {totalQueue > 0 && (
              <span style={{ padding: '5px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: 700, background: '#13132e', color: '#a78bfa', border: '1px solid #2a2a5e' }}>
                {totalQueue} in queue
              </span>
            )}
            <button onClick={fetchData}
              style={{ padding: '7px 16px', fontSize: '12px', fontWeight: 600, background: '#111', color: '#a1a1aa', border: '1px solid #2a2a2a', borderRadius: '8px', cursor: 'pointer' }}>
              Refresh
            </button>
          </div>
        </div>
        ...
        {/* Creator sections */}
        {creators.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '80px', color: '#3f3f46', fontSize: '14px', background: '#111', borderRadius: '16px', border: '1px solid #1a1a1a' }}>
            No creators assigned yet — ask your manager to toggle Social Media Editing on your assigned creators.
          </div>
        ) : (
