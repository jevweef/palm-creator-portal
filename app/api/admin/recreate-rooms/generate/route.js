...
function buildPrompt(lockInventory, change) {
  return (
    ...
    + '• NEVER put clothing on the nightstand or on the dresser / back table — '
    + 'no one drapes clothes there. Those surfaces keep ONLY their normal small '
    + 'items (lamp, candle, glass, phone, books, skincare). Clothes belong on '
    + 'the bed, floor, rug or chair only.\n'
