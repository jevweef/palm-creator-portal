...
function buildPrompt(lockInventory, change) {
  return (
    ...
    + '• KEEP THE DEAD-CENTER FOREGROUND CLEAR: the bottom-center of the frame '
    + '(the open floor right in front of the camera, centered) must stay empty — '
    + 'a person will stand there. Any near-camera item sits off to the far LEFT '
    + 'or far RIGHT edge, never centered at the bottom.\n'
