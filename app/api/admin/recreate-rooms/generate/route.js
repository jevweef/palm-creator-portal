...
function buildPrompt(lockInventory, change) {
  return (
    ...
    + '• Plants & pots are permanent: never ADD, remove, swap, resize or '
    + 'relocate a plant or its pot (no new plant, especially not in front of '
    + 'the nightstand). BUT the trailing vines/tendrils are alive and get '
    + 'watered and nudged — they may hang and drape a LITTLE differently '
    + 'between variations (a few strands fall differently, slightly longer or '
    + 'swept to one side). Same plant, same pot, same spot — only the loose '
    + 'vine drape shifts subtly, never dramatically.\n'
    + '• Cups, coffee mugs, glasses and drinks NEVER go on the floor or rug — '
    + 'they only sit on the nightstand or dresser. A water bottle may stand on '
    + 'the floor; an open cup/mug never does.\n'
    + '• The linen tote bag near the nightstand is a personal item, NOT fixed '
    + 'room identity: it moves around or leaves the room. Re-place it as the '
    + 'staged change says (different spot, or gone entirely) — never keep it '
    + 'frozen in the exact same place as the source if the change moves it.\n'
    + '• The knit throw blanket is BEDDING (transient), NOT fixed identity: '
    + 'its arrangement may change as the staged change describes (folded at '
    + 'the foot, over a corner, across the bed, half off, or absent). Same '
    + 'blanket, just arranged differently — do not treat it as locked.\n'
    + '• Shoes always come as a matching PAIR placed together — never a single '
    + 'lone shoe. They sit near the bed, by a wall or in a corner, not alone '
    + 'in the open middle of the floor or rug.\n'
    + '• Bags, purses, totes and laundry baskets rest AGAINST something — the '
    + 'nightstand, bed, dresser or a wall — never standing alone in the open '
    + 'center where a person walks. Any laundry basket is a modern woven/rattan '
    + 'basket (clean and aesthetic), never a grubby plastic hamper, and never '
    + 'in the foreground.\n'
    + '• Do NOT add furniture — no end-of-bed bench, ottoman, pouf, stool, '
    + 'chair, side table or shelf. The room\'s real furniture is fixed. Folded '
    + 'clothes/towels rest directly on the existing bed, floor, rug, nightstand '
    + 'or dresser — never on an invented bench or table. (A free-standing '
    + 'clothing rack is allowed ONLY if the staged change explicitly names one.)\n'
    + '• The shag rug is soft: its pile realistically looks pushed around, '
    + 'walked-on, a little uneven or footprinted — NOT perfectly vacuumed. But '
    + 'the rug ALWAYS lies flat on the floor: never lifted, peeled, flipped, '
    + 'folded, curled, rolled or bunched up at a corner. Same size, shape, '
    + 'position, flat to the ground.\n'
