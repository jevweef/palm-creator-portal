...
function buildScenePrompt() {
  return (
    ...
    + 'CAMERA SETUP: Think of the output as a selfie SHE took standing '
    + 'inside Figure 2\'s room. The room behind her uses Figure 2\'s full '
    + 'perspective and scale — same landmark sizes (headboard, bed, '
    + 'plants, window, wall décor) as Figure 2. She is positioned CLOSE '
    + 'to the camera at Figure 1\'s exact scale, occupying the same '
    + 'amount of frame as in Figure 1. Both are true together: wide-room '
    + 'background, close-foreground subject. Do NOT shrink her to fit '
    + 'the room.\n\n'
    + 'CONSISTENCY ACROSS RENDERS: Every generation of this same '
    + '(subject, room) pair places the room landmarks at the SAME '
    + 'vertical position behind her. If the bed headboard appears '
    + 'behind her shoulders in one render, it appears behind her '
    + 'shoulders in every render. The decorative wall element (macramé, '
    + 'art) sits at the same height behind her head every time. Lock '
    + 'her distance from the wall; do not vary it between generations.\n\n'
