...
function buildScenePrompt() {
  return (
    ...
    + 'ROOM PLACEMENT BEHIND HER: She is standing CLOSE to the camera at '
    + 'Figure 1\'s exact scale, with the room receding behind her. Show '
    + 'whatever portion of the room directly fits behind her at that close '
    + 'framing — typically the wall/headboard/décor immediately behind her '
    + 'shoulders and above her head. Do NOT shrink her to fit more of the '
    + 'room. Do NOT step her back into the room to expose the floor or '
    + 'full bed. The room is cropped to whatever fits behind her at her '
    + 'Figure-1 scale; it is not the whole room.\n\n'
    + 'CONSISTENCY ACROSS RENDERS: Every generation of this same (subject, '
    + 'room) pair must place the room landmarks at the same vertical '
    + 'position behind her. If the bed headboard top is at her shoulder '
    + 'level in one render, it stays at her shoulder level in every '
    + 'render. The decorative wall element (macramé, art) sits at the '
    + 'same height behind her head every time. Lock these positions; do '
    + 'not vary her distance from the wall between generations.\n\n'
