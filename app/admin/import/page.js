    ...
    <div style={{ maxWidth: '600px' }}>
      ...
      {!preview && !result && (
        <div
          ...
          style={{
            background: dragOver ? '#1a1a2e' : '#111',
      ...
      {/* Preview */}
      {preview && !result && (
        <div style={{ background: '#111', border: '1px solid #222', borderRadius: '10px', padding: '20px' }}>
          ...
          <div style={{ display: 'flex', gap: '24px', marginBottom: '20px' }}>
            <div>
              ...
              <div style={{ fontSize: '20px', fontWeight: 700, color: '#d4d4d8' }}>{preview.totalUrls}</div>
            </div>
            <div>
              <div style={{ fontSize: '10px', color: '#555', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Unique Reels</div>
              <div style={{ fontSize: '20px', fontWeight: 700, color: '#a78bfa' }}>{preview.uniqueReels}</div>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{
                flex: 1, padding: '10px',
                background: importing ? '#333' : '#a78bfa',
            ...
            <button
              onClick={reset}
              style={{ padding: '10px 16px', background: '#1a1a1a', border: '1px solid #333', borderRadius: '6px', color: '#a1a1aa', fontSize: '13px', cursor: 'pointer' }}
            >
              Cancel
            </button>
          </div>
        ...
        <div style={{ background: '#111', border: '1px solid #222', borderRadius: '10px', padding: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginBottom: '20px' }}>
            <div style={{ background: '#0a0a0a', borderRadius: '8px', padding: '12px' }}>
              ...
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#a78bfa' }}>{result.created}</div>
            </div>
            <div style={{ background: '#0a0a0a', borderRadius: '8px', padding: '12px' }}>
              <div style={{ fontSize: '10px', color: '#555', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Already on Board</div>
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#71717a' }}>{result.skippedAlreadyOnBoard}</div>
            </div>
            <div style={{ background: '#0a0a0a', borderRadius: '8px', padding: '12px' }}>
              <div style={{ fontSize: '10px', color: '#555', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Already in Source Reels</div>
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#71717a' }}>{result.skippedAlreadyInSourceReels}</div>
            </div>
            <div style={{ background: '#0a0a0a', borderRadius: '8px', padding: '12px' }}>
              <div style={{ fontSize: '10px', color: '#555', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Total Parsed</div>
              <div style={{ fontSize: '24px', fontWeight: 700, color: '#d4d4d8' }}>{result.totalParsed}</div>
            </div>
          </div>
          <button
            onClick={reset}
            style={{ width: '100%', padding: '10px', background: '#1a1a1a', border: '1px solid #333', borderRadius: '6px', color: '#a1a1aa', fontSize: '13px', fontWeight: 600, cursor: 'pointer' }}
          >
            Import Another File
          </button>
        </div>
