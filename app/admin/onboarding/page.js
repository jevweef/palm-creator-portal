...
export default function AdminOnboarding() {
  ...
  const [contractFile, setContractFile] = useState(null) // optional already-signed / custom PDF to attach
  ...
  const handleStartExisting = async (e) => {
    ...
    // Agency signature only required when not uploading an already-signed contract
          ...
          >
            ...
            <form onSubmit={handleStartOnboarding}>
              ...
              <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                <button
                  type="button"
                  onClick={() => { setShowModal(false); setHasSigDrawn(false); setContractMode('generate'); setContractFile(null); setContractError(null) }}
                  style={{
                    padding: '9px 18px',
          ...
          >
            ...
            <form onSubmit={handleStartExisting}>
              ...
              <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                <button
                  type="button"
                  onClick={() => { setEditCreator(null); setHasSigDrawn(false); setContractFile(null); setContractError(null) }}
